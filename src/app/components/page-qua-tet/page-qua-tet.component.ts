...
@Component({
  selector: 'app-page-qua-tet',
  imports: [CommonModule, HeaderComponent, FooterComponent],
  templateUrl: './page-qua-tet.component.html',
  styleUrl: './page-qua-tet.component.css'
})
export class PageQuaTetComponent {
